...
When the generator processes a spec file named `myservice.jsonc`:
...
│   └── myservice_package.go      # Handlers & dispatcher (generated)
├── cmd/
│   └── myservice/
│       └── myservice_main_cmd.go # CLI main (generated)
├── myservice_impl.go             # Implementation stubs (generated)
└── myservice_commands.go         # Command runner factory (generated)
```
...
- `api/*_package.go` - Generated by the toolkit
- `cmd/*_main_cmd.go` - Generated by the toolkit
- `*_commands.go` - Generated by the toolkit
...
type FieldDef struct {
    ...
    Title      string
    Repeated   bool
    RecRefVal  string  // parsed from "$ref" for recRef type
...
- Tool: wogen (similar generator pattern)
