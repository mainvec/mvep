...
var (
	ErrInvalidProtoMsgEncode = errors.New("wop: Invalid protobuf proto.Message object passed to encode")
	ErrInvalidProtoMsgDecode = errors.New("wop: Invalid protobuf proto.Message object passed to decode")
)
