...
var (
	ErrInvalidProtoMsgEncode = errors.New("mvep: Invalid protobuf proto.Message object passed to encode")
	ErrInvalidProtoMsgDecode = errors.New("mvep: Invalid protobuf proto.Message object passed to decode")
)

// Encode
func Encode(subject string, v interface{}) ([]byte, error) {
	if v == nil {
		return nil, nil
	}
...
// Decode
func Decode(subject string, data []byte, vPtr interface{}) error {
